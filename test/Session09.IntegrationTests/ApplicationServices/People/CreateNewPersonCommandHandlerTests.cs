...
namespace Session09.IntegrationTests.ApplicationServices.People
{
    public class PersonCommandRepositoryFixture : IDisposable
    {
        ...
        public PersonCommandRepositoryFixture()
        {
            ...
            builder.UseSqlServer("Integrated Security=true;Persist Security Info=False;Initial Catalog=PersonDB;Data Source=DESKTOP-O7RN2OF\\MSSQLSERVER_ALI; MultipleActiveResultSets=true");
